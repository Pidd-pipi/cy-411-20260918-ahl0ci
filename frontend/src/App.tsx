...
import { AuditOutlined, BarChartOutlined, FlagOutlined, LogoutOutlined, OrderedListOutlined, SafetyCertificateOutlined, TeamOutlined, UserOutlined } from '@ant-design/icons';
...
const navItems = [
  ...
  { key: '/quotas', icon: <SafetyCertificateOutlined />, label: '地区额度', admin: true },
