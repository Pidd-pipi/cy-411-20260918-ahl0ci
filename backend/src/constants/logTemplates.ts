...
export const LogTemplates = {
  ...
  REGION_QUOTA_LIST_START: 'RegionQuota[region={region}] list start month={month}',
  REGION_QUOTA_STATUS: 'RegionQuota[region={region}] status month={month} used={used} quota={quotaValue}',
  REGION_QUOTA_CREATE_START: 'RegionQuota[region={region}] upsert start month={month} quota_value={quotaValue}',
  REGION_QUOTA_CREATE_SUCCESS: 'RegionQuota[id={id}] upsert success region={region} month={month} quota_value={quotaValue}',
  REGION_QUOTA_CREATE_FAILED: 'RegionQuota[region={region}] upsert failed: {field} {reason}',
  REGION_QUOTA_DELETE_SUCCESS: 'RegionQuota[id={id}] delete success region={region} month={month}',
  REGION_QUOTA_RESERVE_START: 'RegionQuota[region={region}] reserve start month={month} delta={delta} carbon_value={carbonValue}',
  REGION_QUOTA_EXCEEDED: 'RegionQuota[region={region}] reserve rejected month={month}: used={used} quota={quotaValue} requested={requested}',
  REGION_QUOTA_UNCONFIGURED: 'RegionQuota[region={region}] month={month} unconfigured, no cap enforced',
