export const Messages = {
  ...
  FRONTEND_QUOTA_SAVED: '地区月度排放额度已保存',
  FRONTEND_QUOTA_DELETED: '地区月度排放额度已移除',
  FRONTEND_QUOTA_UNCONFIGURED: '当前地区本月未配置排放额度，按原始方式记录',
  FRONTEND_QUOTA_EXCEEDED_HINT: '本月地区排放额度已用尽，该笔记录被拒绝',
